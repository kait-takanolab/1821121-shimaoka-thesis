...
Blockly.Msg["CONTROLS_FOR_TITLE1"] = "%1 を %2 から %3 まで %4 ずつカウントする(<=)";
Blockly.Msg["CONTROLS_FOR_TITLE2"] = "%1 を %2 から %3 まで %4 ずつカウントする(<)";
...
Blockly.Msg["CONTROLS_IF_TOOLTIP_1"] = "条件が正しい場合、ステートメントを実行します。";
Blockly.Msg["CONTROLS_IF_TOOLTIP_2"] = "条件が正しい場合は、最初のステートメントのブロックを実行します。それ以外の場合は、2番目のステートメントのブロックを実行します。";
